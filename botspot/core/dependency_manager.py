...
if TYPE_CHECKING:
    ...
    from botspot.components.new.subscription_manager import SubscriptionManager
...
class DependencyManager(metaclass=Singleton):
    ...
    @property
    def simple_user_cache(self) -> Optional["SimpleUserCache"]:
        return self._simple_user_cache
    ...
    def subscription_manager(self, value):
